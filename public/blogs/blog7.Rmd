...
brexit_results %>% 
 ...
 select(leave_share, ukip_2015, born_in_uk, male) %>% 
   GGally::ggpairs()
```
While it looks like the percentage of males has little to no influence on the Brexit vote outcome, there appears to be a reasonably big correlatin between the percentage of UK-born inhabitants and the 'leave'-share.
